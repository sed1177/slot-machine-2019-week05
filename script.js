...
const shows = ["Money Heist", "Love Island", "Prison Break", "Breaking Bad", "Stranger Things", "Naruto", "Monsters Inc"]
...
function randomShow() {
  // returns the array with the index as a random show from the array 
...
// reset balace to ZERO and put ? in each show box 
